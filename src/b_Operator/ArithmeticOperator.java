...
public class ArithmeticOperator {
	...
	public static void main(String[] args) {
		 ...
		 * - / : 나누기
		 * - % : 나머지
		 * - 이항 연산자는 양쪽의 피연산자의 타입이 일치해야 연산이 가능한다 * 
		 */
		...
		//a = 10 + 20.3; double 값을 int에 저장하려 해서 에러가 발생 
		...
		byte b = 10;
		short c = 20;
		//short d = c - b; - c와 b가 int로 형변화 하려함
		...
		long e2 = 100000 * 100000L; //피연산자 중 하나는 long이여야 결과로
...
//		int g1 = 10 / 0; // 런타임 에러 발생
		...
		//소수점 두째자리에서 반올림해주세요.
		round = 3.14 ;
		System.out.println((int)(round * 10 + 0.5) / 10f);//3.1
		System.out.println((int)(round+ 0.05) ); //3
		
		//다음을 한줄식 계산해서 최종값을 출력해주세요
		//1. 123456 + 654321
		//2. 1번의 결과값 * 123456
		//3. 2번의 결과값 / 123456
		//4. 3번의 결과값 - 654321
		...
		//3개의 int형 변수를 선언 및 초기와 후 합계와 평균을 구해주세요
		//(평균은 소수점 두째자리에서 반올림)
